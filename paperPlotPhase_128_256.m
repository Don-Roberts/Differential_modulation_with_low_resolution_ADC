...
%semilogy(SNRdB(1:end_), ber1NoADC_48_100_2(1:end_),'g-+','LineWidth',line_thick,'MarkerSize',mark_thick)
%semilogy(SNRdB(1:end_), ber1NoADC_64_100_2(1:end_),'g-p','LineWidth',line_thick,'MarkerSize',mark_thick)
...
legend({'Diff: $L = 11$ , $U = 128$';'Diff: $L = 11$ , $U = 256$';'Diff: $L = 31$ , $U = 128$';'Diff: $L = 31$ , $U = 256$';...
'$\xi = 0.5$, $L = 11$ , $U = 128$';'$\xi = 0.5$, $L = 11$ , $U = 256$';'$\xi = 0.5$, $L = 31$ , $U = 128$';'$\xi = 0.5$, $L = 31$ , $U = 256$';    
'$\xi = 0.125$, $L = 11$ , $U = 128$';'$\xi = 0.125$, $L = 11$ , $U = 256$';'$\xi = 0.125$, $L = 31$ , $U = 128$';'$\xi = 0.125$, $L = 31$ , $U = 256$';    
